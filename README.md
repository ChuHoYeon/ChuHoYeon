...
### <div align="center">👋 안녕하세요, 더 나은 코드를 고민하며 차근차근 기본기를 쌓아가는 백엔드 개발자 추호연입니다.</div>

<div align="center">
  안정적인 데이터 흐름과 견고한 아키텍처에 관심을 가지고 있으며,<br>사용자에게 신뢰받는 백엔드 환경을 구축하는 과정에서 즐거움을 느낍니다.
</div>
...
* ![Docker](https://img.shields.io/badge/docker-%230db7ed.svg?style=flat-square&logo=docker&logoColor=white) **Docker:** 서비스의 컨테이너화 및 배포 자동화 과정을 학습 중입니다.
* ![Redis](https://img.shields.io/badge/redis-%23DD0031.svg?style=flat-square&logo=redis&logoColor=white) **Redis:** 데이터 캐싱을 통한 API 성능 최적화에 관심이 많습니다.
* ![Vue.js](https://img.shields.io/badge/vuejs-%2335495e.svg?style=flat-square&logo=vuedotjs&logoColor=%234FC08D) **Vue.js:** 백엔드와 유기적으로 통신하는 프론트엔드 환경을 이해하기 위해 공부하고 있습니다.
...
**Get in touch** <a href="mailto:dkzlshzl99@gmail.com">
